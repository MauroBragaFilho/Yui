...
const CONFIG_PAGES = [
    ...
    {
        key: 'groqApiUrl',
        label: 'URL da API GROQ',
        category: '🔗 Endpoints & Modelos',
        icon: '🌐',
        type: 'string',
        persistence: 'json',
        configKey: 'groqApiUrl',
        summary: 'Endpoint da API do GROQ.',
        description: 'URL do endpoint de chat completions do GROQ. Padrão: "https://api.groq.com/openai/v1/chat/completions". Compatível com o formato OpenAI. Não altere a menos que esteja usando um proxy.',
    },
    {
        key: 'hordeUrl',
