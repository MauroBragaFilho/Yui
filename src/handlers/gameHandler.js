    ...
    try {
        ...
        const renderPage = (page) => {
            ...
            const embed = new EmbedBuilder()
                ...
                .setColor('#8F55FD')
                .setFooter({ text: 'Hikari Torrent • by yGuilhermy' });
...
module.exports = { executeGameCommand, searchGames, getTorrentOrMagnet, createPaginationComponents, normalizeString };