...
- **Spotify**:
  - Intelligent resolution of tracks (`open.spotify.com/track/...`), albums (`/album/...`), and playlists (`/playlist/...`).
  - Extracts metadata from Spotify and automatically matches/streams high-quality audio from **Deezer**.
- **Deezer**:
